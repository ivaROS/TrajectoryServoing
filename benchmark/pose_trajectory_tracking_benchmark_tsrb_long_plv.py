...
path_directory = '/home/shiyu/meta_slam_ws/src/trajectory_servoing/offline_trajs/shortBenchTraj'
path_slam_config = '/home/shiyu/meta_slam_ws/src/trajectory_servoing/configs/slam_configs'
...
for ri, num_gf in enumerate(Number_GF_List):
    ...
    if noise:
        Experiment_prefix = 'noise_' + noise_std + '/pose'
    else:
